...
z = z / L
r1 = max(0, 0.64212 - (0.04777 + 0.98234 * z2) ** 0.5)
r2 = 1 - 0.18453 * z2 + 0.10158 * math.exp(-11 * (1 - z**2) - math.exp(-11))
# print("r1: ",r1)
# print("r1: ",r2)
print(f'x1 x: {zL}, y: {r1}')
print(f'x2 x: {zL}, y: {r2}')
...
gmsh.model.geo.addLine(p1_list[-1], p2_list[-1], 2)
...
# 创建表面
gmsh.model.geo.addCurveLoop([1, spl1, 2, -spl2])
